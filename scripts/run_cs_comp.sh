...
python src/Experiment1.py --method_suite comp_cs --N 500 --mode cs --out_path figures/comp_cs/exp1_inv_2_cs.tex --seed $SEED --small_prop 0.2 --f_method inv
python src/Experiment1.py --method_suite comp_cs --N 500 --mode cs --out_path figures/comp_cs/exp1_inv_8_cs.tex --seed $SEED --small_prop 0.8 --f_method inv
python src/Experiment1.py --method_suite comp_cs --N 500 --mode cs --out_path figures/comp_cs/exp1_prop_2_cs.tex --seed $SEED --small_prop 0.2 --f_method prop
python src/Experiment1.py --method_suite comp_cs --N 500 --mode cs --out_path figures/comp_cs/exp1_prop_8_cs.tex --seed $SEED --small_prop 0.8 --f_method prop
